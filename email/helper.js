...
var defaultEmailConfig = {
  from: '"Festive" <no-reply@festive.com.ar>',
	subject: '',
	template: '',
  data: {},
  tags: {
    proveedor: {
      footerText: '¡Tu evento al alcance de todos!',
      mailTo: 'proveedores@festive.com.ar'
    },
    cliente: {
      footerText: '¡Tu evento a un click!',
      mailTo: 'consultas@festive.com.ar'
    }
  }
}
...
Client.prototype.send = function (emailConfig) {
  ...
  return (new Promise(function(resolve,reject){
    ...
    if (emailConfig.data.tag) {
      emailConfig.data.tags = emailConfig.tags[emailConfig.data.tag]
    }
